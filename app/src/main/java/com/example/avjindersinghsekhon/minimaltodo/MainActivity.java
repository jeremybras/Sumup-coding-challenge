...
import com.example.avjindersinghsekhon.minimaltodo.checkout.PaymentActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int REQUEST_SUMUP_LOGIN = 155;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        theme = getSharedPreferences(THEME_PREFERENCES, MODE_PRIVATE)
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREF_DATA_SET_CHANGED,
                                                                   MODE_PRIVATE);
        ...
        final android.support.v7.widget.Toolbar toolbar = (android.support.v7.widget.Toolbar) findViewById(
            R.id.toolbar);
    ...
    protected void onResume() {
        ...
        if (getSharedPreferences(THEME_PREFERENCES, MODE_PRIVATE)
            .getBoolean(RECREATE_ACTIVITY, false)) {
            SharedPreferences.Editor editor = getSharedPreferences(THEME_PREFERENCES, MODE_PRIVATE)
                .edit();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_ID_TODO_ITEM && resultCode != RESULT_CANCELED) {
            ...
            for (int i = 0; i < mToDoItemsArrayList.size(); i++) {
                if (item.getIdentifier()
                        .equals(mToDoItemsArrayList.get(i).getIdentifier())) {
        ...
        } else if (requestCode == REQUEST_SUMUP_LOGIN) {
            if (!SumUpAPI.isLoggedIn()) {
                Toast.makeText(this, "Not logged in", Toast.LENGTH_SHORT).show();
            } else {
                Merchant currentMerchant = SumUpAPI.getCurrentMerchant();
                Toast.makeText(this, "Merchant logged in " + currentMerchant.getMerchantCode(),
    ...
    private boolean doesPendingIntentExist(Intent i, int requestCode) {
        PendingIntent pi = PendingIntent
            .getService(this, requestCode, i, PendingIntent.FLAG_NO_CREATE);
        return pi != null;
    }
    ...
    private void createAlarm(Intent i, int requestCode, long timeInMillis) {
        ...
        PendingIntent pi = PendingIntent
            .getService(this, requestCode, i, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public class BasicListAdapter extends RecyclerView.Adapter<BasicListAdapter.ViewHolder>
            ...
            Snackbar.make(mCoordLayout, "Deleted " + toShow, Snackbar.LENGTH_SHORT)
                    .setAction("UNDO", new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (mJustDeletedToDoItem.getToDoDate() != null && mJustDeletedToDoItem
                                .hasReminder()) {
        ...
        public void onBindViewHolder(final BasicListAdapter.ViewHolder holder, final int position) {
            ...
            TextDrawable myDrawable = TextDrawable.builder().beginConfig()
                                                  ...
                                                  .toUpperCase()
                                                  .endConfig()
                                                  .buildRound(item.getToDoText().substring(0, 1),
                                                              item.getTodoColor());
            ...
            if (item.getToDoDate() != null) {
                ...
                if (android.text.format.DateFormat.is24HourFormat(MainActivity.this)) {
                    timeToShow = AddToDoActivity
                        .formatDate(MainActivity.DATE_TIME_FORMAT_24_HOUR, item.getToDoDate());
                } else {
                    timeToShow = AddToDoActivity
                        .formatDate(MainActivity.DATE_TIME_FORMAT_12_HOUR, item.getToDoDate());
                }
